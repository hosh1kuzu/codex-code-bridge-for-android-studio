...
`Codex Code Bridge` 是一个 Android Studio 插件，用来把当前选中代码的位置快速复制成适合粘贴到 Codex 对话框里的 Markdown 文件链接。
...
`build/distributions/codex-code-bridge-0.3.0.zip`
